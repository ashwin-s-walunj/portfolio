...
const Home = () => {
    ...
    const skillCategories = [
        ...
        {title: 'Tools', icon: <Wrench className="w-5 h-5"/>, skills: portfolioData.skills.tools},
        {title: 'Concepts', icon: <Layers2 className="w-5 h-5"/>, skills: portfolioData.skills.concepts},
        {title: 'AI', icon: <Workflow className="w-5 h-5"/>, skills: portfolioData.skills.ai},
    ];
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0b]">
            ...
            <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
                ...
                <div
                    className="absolute inset-0 bg-[linear-gradient(rgba(0,217,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,217,255,0.03)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black,transparent)]"/>
                    ...
                    <div className="grid md:grid-cols-[300px_1fr] gap-12 items-start mb-12">
                        ...
                        <div className="mx-auto md:mx-0">
                            <div className="relative group">
                                <div
                                    className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
                                <img
            ...
            {/* Projects Section */}
            <section id="projects" className="py-20 px-4 bg-[#0f0f11]">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-16">
            ...
            <section id="achievements" className="py-20 px-4 bg-[#0f0f11]">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {portfolioData.achievements.map((achievement) => (
                            <Card key={achievement.id}
                                ...
                                <CardContent className="p-6">
                                    <div
                                        className="bg-cyan-500/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                                        {achievement.icon === 'award' && <Award className="w-6 h-6 text-cyan-400"/>}
                                        {achievement.icon === 'users' && <Users className="w-6 h-6 text-cyan-400"/>}
                                        {achievement.icon === 'code' && <Code2 className="w-6 h-6 text-cyan-400"/>}
                                    </div>
                    ...
                    <div className="mt-16">
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            {portfolioData.languages.map((language, idx) => (
                                <Card key={idx}
                                      className="bg-[#151518] border-cyan-500/20 hover:border-cyan-500/40 transition-all">
                                    <CardContent className="p-6 text-center min-w-[200px]">
                                        <h4 className="text-white font-bold text-lg mb-1">{language.name}</h4>
                            ...
                            <CardContent className="p-8 md:p-12">
                                ...
                                <div className="border-t border-cyan-500/20 pt-6">
                                    <h4 className="text-white font-bold text-lg">
                                        <a href={portfolioData.recommendations[currentRecommendation].linkedIn}
                                           target={"_blank"}>
                                            <Linkedin/>{portfolioData.recommendations[currentRecommendation].name}
                                        </a>
                                    </h4>
